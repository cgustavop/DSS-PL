...
public class CampeonatoAtivoDAO implements Map<Integer,CampeonatoAtivo> {
                ...
                try(ResultSet rsDj = stm.executeQuery(sql)){
                    while(rsDj.next()){
                        ...
                        if(corrMap.containsKey(nrCorrida)){
                            var posMap = corrMap.get(nrCorrida);
	...
	@Override
	public void putAll(Map<? extends Integer, ? extends CampeonatoAtivo> m) { // TODO
	...
	@Override
	public Set<Integer> keySet() { // TODO
	...
	@Override
	public Collection<CampeonatoAtivo> values() { // TODO
	...
	@Override
	public Set<Entry<Integer, CampeonatoAtivo>> entrySet() { // TODO
